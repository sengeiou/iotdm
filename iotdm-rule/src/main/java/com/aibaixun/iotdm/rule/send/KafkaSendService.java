...
public class KafkaSendService implements SendService {
    ...
    public  KafkaProducer<String,String> generateClient(KafkaResourceConfig config) {
        ...
        if (Objects.isNull(kafkaConnectionResource)){
            ...
            Integer connectTime = Objects.nonNull(config.getConnectTimeout())?config.getConnectTimeout()*100:6000;
            ...
            Integer reqTimeout  = Objects.nonNull(config.getReqTimeout())?config.getReqTimeout()*100:6000;
